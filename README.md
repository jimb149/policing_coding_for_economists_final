...
3. Run the `.do` files or the `.py` files that are relevant for your research. 
4. Cleaned data and output files will appear in their respective folders, as instructed to be created in the `.do` files or the `.py`.
